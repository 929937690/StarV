...
class Test(object):
    ...
    def test_reachExactMultiInputs(self):
        ...
        try:
            ...
            S = SatLins.reachExactMultiInputs(In, 'gurobi', pool)
            print('\nNumber of input sets = {}'.format(len(In)))
            print('\nNumber of output sets = {}'.format(len(S)))
            pool.close()
        except Exception:
...
if __name__ == "__main__":
    ...
    ================================\
    ===============================\n')
    test_SatLins.test_evaluate()
    test_SatLins.test_stepReach()
    test_SatLins.test_stepReachMultiInputs()
    test_SatLins.test_reachExactSingleInput()
    test_SatLins.test_reachExactMultiInputs()
    print('\n========================\
    =================================\
    =================================\
    =================================\n')
    print('Testing ProbStar Class: fails: {}, successfull: {}, \
    total tests: {}'.format(test_SatLins.n_fails,
                            test_SatLins.n_tests - test_SatLins.n_fails,
                            test_SatLins.n_tests))
