...
def quantiverify_ACASXU_all_ReLU(x, y, spec_ids, numCores, unsafe_mat, unsafe_vec, p_filters):
    ...
    path = "artifacts/NAHS2024/ACASXU/ReLU"
...
def quantiverify_ACASXU_all_LeakyReLU(x, y, spec_ids, numCores, unsafe_mat, unsafe_vec, p_filters):
    ...
    # save verification results
    path = "artifacts/NAHS2024/ACASXU/LeakyReLU"
    if not os.path.exists(path):
        os.makedirs(path)
...
def quantiverify_ACASXU_all_SatLin(x, y, spec_ids, numCores, unsafe_mat, unsafe_vec, p_filters):
    ...
    # save verification results
    path = "artifacts/NAHS2024/ACASXU/SatLin"
    if not os.path.exists(path):
        os.makedirs(path)
...
def quantiverify_ACASXU_all_SatLins(x, y, spec_ids, numCores, unsafe_mat, unsafe_vec, p_filters):
    ...
    # save verification results
    path = "artifacts/NAHS2024/ACASXU/SatLins"
    if not os.path.exists(path):
        os.makedirs(path)
...
if __name__ == "__main__":
    ...
    # quantiverify_ACASXU_all_ReLU(x=x, y=y, spec_ids=s, numCores=16, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])
    ...
    # x = [2]
    # y = [6] 
    # s = [2] # property id, not working

    # # quantiverify_ACASXU_all_SatLin(x=x, y=y, spec_ids=s, numCores=16, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])
    # quantiverify_ACASXU_all_SatLin(x=x, y=y, spec_ids=s, numCores=16, unsafe_mat=None, unsafe_vec=None, p_filters=[1e-5])
    ...
    s = [4]
    # Testing for ReLU
    quantiverify_ACASXU_all_ReLU(x=x, y=y, spec_ids=s, numCores=8, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])
    # Testing for LeakyReLU
    quantiverify_ACASXU_all_LeakyReLU(x=x, y=y, spec_ids=s, numCores=8, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])
    # Testing for SatLin
    quantiverify_ACASXU_all_SatLin(x=x, y=y, spec_ids=s, numCores=8, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])
    # Testing for SatLins
    quantiverify_ACASXU_all_SatLins(x=x, y=y, spec_ids=s, numCores=8, unsafe_mat=None, unsafe_vec=None, p_filters=[0.0, 1e-5])